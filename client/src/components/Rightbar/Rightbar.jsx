...
const Rightbar = ({mobileOpen, handleDrawerToggle}) => {
  ...
  return (
    <>
    <Toolbar />
    <Box flex={3} sx={{ml:1, backgroundColor:theme.palette.background.default, height:'100%', maxWidth:300, zIndex: 2, backdropFilter: 'blur(3px)', display:'flex', flexDirection:'column', alignItems:'flex-start'}}>
    ...
    <Box sx={{p:1, width:'100%'}}>
        <Button variant="contained" color="info" sx={{width:'100%',minHeight:42, color:'#ffffff', backgroundColor:'#2196f3'}}>
